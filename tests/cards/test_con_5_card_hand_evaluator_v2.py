...
with open(os.path.join(module_dir, 'con_5_card_hand_evaluator_v2.py'), 'r') as f:
    code = f.read()
    client.submit(code, name='con_5_card_hand_evaluator_v2')
...
class MyTestCase(unittest.TestCase):
    ...
    def test_5_card_hands(self):
        client.signer = 'me'        
        contract = client.get_contract('con_5_card_hand_evaluator_v2')
