...
@export
def leave_game(game_id: str, player: str, games: Any, players_games: Any, hands: Any, hand_controller_contract: str):
    players = get_players_and_assert_exists(game_id, games)
    ...
    if hand_id is not None:
        I.load_module(hand_controller_contract).leave_hand(
            hand_id=hand_id,
            player=player,
            hands=hands
        )
